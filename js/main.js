...
const blogData = {
    1: {
        ...
        date: 'Ngày 17 tháng 05, 2026 | Tác giả: Minh Luân Store',
    ...
    2: {
        ...
        content: `
            <p>Mất thời gian đổi trả do mua nhầm size giày là tình huống cực kỳ phiền phức khi mua sắm trực tuyến. Mỗi hãng giày như Nike, Adidas hay Vans đều có phom chuẩn riêng lẻ. Để chọn được đôi giày vừa vặn tuyệt đối tại Minh Luân Store, bạn hãy làm theo các bước sau:</p>
    ...
    3: {
        ...
        date: 'Ngày 12 tháng 05, 2026 | Tác giả: Stylist Minh Luân',
